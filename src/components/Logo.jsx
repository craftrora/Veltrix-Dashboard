  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      <svg
        ...
        aria-hidden="true"
      >
        <path d="M20 1.5 36.6 11v18L20 38.5 3.4 29V11Z" fill="url(#veltrix-grad)" />
        <path
        ...
        />
        <defs>
          <linearGradient id="veltrix-grad" x1="3.4" y1="1.5" x2="36.6" y2="38.5" gradientUnits="userSpaceOnUse">
